...
if(isset($_POST['submit'])){
   ...
   $pword         = $_POST['pword'] != "" ? $_POST['pword'] : ""; 
   
  $userlogin = new User();
  $select_res = $userlogin->login($username,$pword);
}
	...
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100">
				<form name="login" action="<?php echo $_SERVER["PHP_SELF"];?>" method="POST" class="login100-form validate-form">
